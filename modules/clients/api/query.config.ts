 ...
 * sorting, and searching on Client entities.
 *
 * ARCHITECTURAL BOUNDARIES:
 * ✅ CAN import: ../domain/types (IClient for type checking)
...
/**
 * Client Query Parser Configuration
 *
 ...
 * - Website URL
 */
export const clientQueryConfig: StrictQueryParserConfig<
  IClient,
  ExcludedClientFields
> = {
  searchFields: {
    textFields: [
      "company.name",
