...
/**
 * Integration Test: Client Website Research - AI Extraction Only
 *
 * Tests the AI-powered website research functionality.
 * Uses real AI providers to verify the research and extraction workflow.
 */

import { clientsService } from "@/modules/clients/application/service";

describe("Client Website Research - AI Extraction", () => {
